...
def run_sys():
	...
	#		output.append("BTCSC  = " + ticker['BTC_SC']['last'])
			...
			output.append(" ")
			output.append("OK-POLO_LSK/RMB = "+ str('%.3f' % ok_polo_lskrmb) +", " + str('%.2f' % lsk_diff_opj)+"%  | JB-POLO_LSK/RMB = "+ str('%.3f' % jb_polo_lskrmb)+ ", " + str('%.2f' % lsk_diff_jpj)+"%")
			output.append("OK-BITX_LSK/RMB = "+ str('%.3f' % ok_bitx_lskrmb) +", " + str('%.2f' % lsk_diff_obj)+"%  | JB-BITX_LSK/RMB = "+ str('%.3f' % jb_bitx_lskrmb)+ ", " + str('%.2f' % lsk_diff_jbj)+"%")
			output.append(" ")
